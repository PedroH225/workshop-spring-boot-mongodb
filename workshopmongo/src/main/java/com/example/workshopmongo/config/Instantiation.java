...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Setting off on a trip!", "I'm setting off on a trip to São Paulo, Bye!", 
        new AuthorDTO(maria));
        ...
        CommentDTO c3 = new CommentDTO("Have a great day!", sdf.parse("21/03/2018"), new AuthorDTO(alex));
